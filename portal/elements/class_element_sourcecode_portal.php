...
class class_element_sourcecode_portal extends class_element_portal implements interface_portal_element {
    ...
    public function loadData() {
        $strFeedTemplateID = $this->objTemplate->readTemplate("/element_rssfeed/" . $this->arrElementData["char1"], "sourcecode");
        return $this->objTemplate->fillTemplate(array("code" => nl2br($this->arrElementData["text"])), $strFeedTemplateID);
    }
